...
## Project Structure
    ...
    ├── school_application_40157  # Django project configurations
...
1. Clone this repo and `cd school_application_40157`
...
2. Clone this repo and `cd school_application_40157`
